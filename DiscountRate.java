...
public class DiscountRate {
    public static void main(String[] args) {
        ...
        int discountChoice = buat.nextInt();
        
        // Assign discount rate based on user choice
        switch (discountChoice) {//formula for choosing different discount
            case 1:
                discrate = 10;//discount option 1
                break;
            case 2:
                discrate = 20;//discount option 2
                break;
            case 3:
                discrate = 30;//discount option 3
                break;
            case 4:
                discrate = 40;//discount option 4
                break;
            default:
